...
## Purpose
The locked "Ink & Substrate" token pipeline — one source of truth built to CSS variables and a Tailwind preset, with dark mode and density as pure semantic-layer remaps.
