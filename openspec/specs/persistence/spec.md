...
## Purpose
A framework-agnostic database package (drizzle + Postgres) defining the platform tables, shared column conventions, string-typed numerics, migrations, and an idempotent dev seed.
