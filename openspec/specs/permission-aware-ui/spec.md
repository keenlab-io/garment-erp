...
## Purpose
Client-side permission gating driven only by the contracts catalog: absent-versus-disabled rules, field-level masking, and guarded-action confirmation flows.
