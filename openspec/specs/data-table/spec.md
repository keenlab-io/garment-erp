...
## Purpose
The shared table organism: sortable sticky headers, cursor pagination matching the contract page shape, density-aware rows, money and quantity columns, row and bulk actions, saved column presets, and loading/empty/error states.
