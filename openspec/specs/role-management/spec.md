...
## Purpose
The persisted permission catalog and the role lifecycle — create, clone, template, update, and guarded delete — with permissions-version bumps that revoke affected tokens.
