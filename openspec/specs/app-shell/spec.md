...
## Purpose
The persistent application frame — role-filtered navigation, breadcrumb, theme/density/locale controls, and command palette — that every module screen renders inside.
