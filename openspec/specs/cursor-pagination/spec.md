...
## Purpose
Uniform cursor-based pagination: standard query parameters, a standard response envelope, and an opaque base64url cursor over a stable deterministic ordering.
