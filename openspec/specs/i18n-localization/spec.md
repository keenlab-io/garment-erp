...
## Purpose
Thai-first bilingual UI with a persisted locale toggle, no hardcoded user-facing strings, layouts that tolerate bilingual expansion, and locale-aware formatting that keeps money as strings.
