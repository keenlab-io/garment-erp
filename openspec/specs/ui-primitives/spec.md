...
## Purpose
The owned component layer built on headless Radix primitives — buttons, form fields, Ink-Chips, money and quantity cells, dialogs, and feedback containers — meeting a WCAG 2.1 AA baseline.
