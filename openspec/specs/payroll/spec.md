...
## Purpose
The payroll run lifecycle — one per period, asynchronous calculation with an immutable breakdown snapshot, the canonical net-pay formula, and single-shot approval that pulls outstanding advances.
