...
declare module "@tanstack/react-router" {
  interface StaticDataRouteOption {
    ...
    title?: ShellKey | IamKey | HrKey | InventoryKey | ProductionKey | SalesKey | ReportingKey;
    /** Override key when the breadcrumb label differs from the title. */
    breadcrumb?: ShellKey | IamKey | HrKey | InventoryKey | ProductionKey | SalesKey | ReportingKey;
